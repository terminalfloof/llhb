...
class DebugTool {
  constructor() { this._glitchDebug = false; }

  get glitchDebug() { return this._glitchDebug; }
...
function showEnd(date, endMessage) {
  ...
  function showRemaining() {
    ...
    var days = Math.floor(distance / _day).toString().padStart(2, "0");
    var hours =
        Math.floor((distance % _day) / _hour).toString().padStart(2, "0");
    var minutes =
        Math.floor((distance % _hour) / _minute).toString().padStart(2, "0");
    var seconds =
        Math.floor((distance % _minute) / _second).toString().padStart(2, "0");
    var html = `${days}.${hours}.${minutes}.${seconds}`;
    html = html.toString().split("00").join(
          ...
          $("#inputdiv").fadeOut(500, function() {
            $("#inputdiv").hide(() => {
              ...
              if (data.name === "?????") {
                ...
                $("#app").html(
                    `Welcome to the MDBS, <span class="glitch" style="font-size: 1em" data-text="${
